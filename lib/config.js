...
const DEFAULT_CONFIG = {
  ...
  fileExtensions: [
    ...
    "vue", "svelte", "astro",
    // Markup
    "html", "htm", "xml", "svg", "xhtml", "pug", "jade",
    // Templating
    "handlebars", "hbs", "mustache", "ejs", "njk", "liquid",
    // Python
    "py", "pyw", "pyx", "pxd", "pxi", "ipynb",
    // Java/JVM
    "java", "kt", "kts", "groovy", "gvy", "gradle", "scala", "sbt", "clj", "cljs", "cljc", "edn",
    // C/C++ family
    "c", "cpp", "cc", "cxx", "h", "hpp", "hxx", "h++", "m", "mm",
    // .NET
    "cs", "csx", "vb", "vbs", "fs", "fsx", "fsi",
    // System
    "go", "rs", "rlib", "swift",
    // Ruby
    "rb", "erb", "rake", "gemspec",
    ...
    "r", "rmd", "jl",
    // Shell/Config
    "sh", "bash", "zsh", "fish", "ksh", "csh", "tcsh", "bat", "cmd", "ps1", "psm1",
    "json", "json5", "jsonc",
    ...
    // Docs
    "md", "markdown", "mdx", "txt", "rst", "adoc", "asciidoc", "tex", "latex",
    // Functional/Other
    "lua", "pl", "pm", "t", "dart",
    "el", "lisp", "lsp", "scm", "ss",
    "erl", "hrl", "ex", "exs",
  ...
  fileNames: [
    "Dockerfile", "Containerfile", "Makefile", "Jenkinsfile", "Vagrantfile", "CMakeLists.txt",
    ".gitignore", ".env", "docker-compose.yml", "docker-compose.yaml"
  ],
  excludePatterns: [
    "**/node_modules/**",
    "**/dist/**",
